...
export default function NewFixturePage() {
  ...
  // Build a local datetime default 7 days from now
  ...
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Schedule an upcoming match.</p>
      </div>
      ...
      <form action={formAction} className="space-y-5">
        ...
        <div className="flex gap-3">
          ...
          <Button asChild variant="outline">
            <Link href="/dashboard/coach/fixtures">Cancel</Link>
          </Button>
        </div>
      </form>
    </div>
